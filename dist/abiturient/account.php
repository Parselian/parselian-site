        ...
        <form id="form" method="POST" action="control/functions/user/send-form.php" enctype="application/json">
          ...
          <div class="account-form-block account-form-block_personal">
            ...
            <div class="account-form-group">
              ...
              <input id="personal-surname" type="text" class="account-form__input" name="form-surname" value="Янкилевич" required>
            </div>
            <!-- /.account-form-group -->

            <div class="account-form-group">
              <label for="personal-name" class="account-form__label account-form__label_required">Имя</label>
              <input id="personal-name" type="text" name="form-abiname" class="account-form__input" value="Ержан" required>
            </div>
            <!-- /.account-form-group -->
            ...
            <div class="account-form-group">
              ...
              <input id="personal-borndate" type="date" value='2018-07-22' name="form-born_date" class="account-form__input" required>
            </div>
            <!-- /.account-form-group -->
          ...
          <div class="account-form-block account-form-block_passport hidden">
            ...
            <div class="account-form-group">
              ...
              <input id="passport-date" type="date" value='2018-07-22' name="form-pass_date" class="account-form__input" required>
            </div>
            <!-- /.account-form-group -->
          ...
          <div class="account-form-block account-form-block_education hidden">
            ...
            <div class="account-form-group">
              ...
              <input id="education-name" type="text" name="form-edu_name" class="account-form__input" value="Колледж" required>
            </div>
            <!-- /.account-form-group -->
            ...
            <div class="account-form-group">
              ...
              <input id="education-date" type="date" value='2018-07-22' name="form-edu_date" class="account-form__input" required>
            </div>
            <!-- /.account-form-group -->
